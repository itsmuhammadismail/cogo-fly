...
!(function (e) {
  ...
  function (t, n, e) {
    ...
    function u(t, n) {
      ...
      return (
        v(n, function (t, n) {
          r(t) ? (r(e[n]) || (e[n] = {}), (e[n] = u(e[n], t))) : (e[n] = t);
        }),
        e
      );
    }
    ...
    var N = "splide",
      R = { active: "is-active", visible: "is-visible", loading: "is-loading" },
      B = {
        type: "slide",
        rewind: !1,
        speed: 400,
      ...
      var r = {
        mount: function () {
          ...
          !(function () {
            (r.slider = _(e, i.slider)),
              ...
              D(r.track && r.list, "Track or list was not found."),
              (r.slides = g(r.list.children));
            var t = s(i.arrows);
            r.arrows = { prev: c(t, "." + i.prev), next: c(t, "." + i.next) };
            var n = s(i.autoplay);
            (r.bar = c(s(i.progress), "." + i.bar)),
              (r.play = c(n, "." + i.play)),
              (r.pause = c(n, "." + i.pause)),
        ...
        register: function (t, n, e) {
          var c,
            ...
            u =
              ...
              (a = {
                ...
                index: d,
                realIndex: i,
                container: _(o, c.classes.container),
                isClone: -1 < i,
                mount: function () {
                  var t = this;
                  this.isClone || (o.id = c.root.id + "-slide" + x(d + 1)),
                    c
                      .on(s, function () {
                        return t.update();
                      })
                    ...
                    r &&
                      c.on("move.slide", function (t) {
                        t === i && l(!0, !1);
                      }),
                    P(o, { display: "" }),
                    (this.styles = W(o, "style") || "");
                },
                destroy: function () {
                  c.off(s).off(et).off("click", o), I(o, g(R)), f();
                },
                update: function () {
                ...
                isVisible: function () {
                  var t = this.isActive();
                  if (c.is(H) || t) return t;
                  var n = Math.floor,
                    e = c.Components,
                    i = e.Track,
                    o = e.Layout,
                    r = c.options.direction === nt,
                    s = n(
                      (i.toPosition(d) + i.offset(d) - i.position) * i.sign
                    ),
                    a = n(s + o[r ? "slideHeight" : "slideWidth"](d)),
                    u = o[r ? "height" : "width"];
                ...
                isWithin: function (t, n) {
                  var e = Math.abs(t - d);
                  return (
                    c.is(T) || this.isClone || (e = Math.min(e, c.length - e)),
                    e < n
                  );
                },
              }));
          function l(t, n) {
            ...
            t
              ? (C(o, i), c.emit(e, a))
              : M(o, i) && (I(o, i), c.emit(n ? "hidden" : "inactive", a));
          }
          function f() {
            O(o, "style", a.styles);
          }
        ...
        a = {
          ...
          toIndex: function (t) {
            ...
            var n = r.length,
              ...
              i = t * e;
            return (
              n - e <= (i -= (this.pageLength * e - n) * it(i / n)) &&
                i < n &&
                (i = n - e),
              i
            );
    ...
    function Z(s, a) {
      var o,
        ...
        d,
        l = 0,
        n = s.options.direction === nt,
        f = s.is(H),
        h = m(
          {
            mount: function () {
              (o = a.Elements.list), this.init();
            },
            mounted: function () {
              var t = this;
              f ||
                s.on("mounted resize updated", function () {
                  t.jump(s.index);
                });
            },
            go: function (t, n, e) {
              ...
              e || s.emit("move", n, r, t),
                1 <= Math.abs(o - l) || f
                  ? a.Transition.start(t, n, r, this.toCoord(o), function () {
                      i.end(t, n, r, e);
                    })
                  : t !== r && "move" === s.options.trimSpace
                  ? a.Controller.go(t + t - r, e)
                  : this.end(t, n, r, e);
            },
            end: function (t, n, e, i) {
              P(o, { transition: "" }),
                f || this.jump(n),
                i || s.emit("moved", n, e, t);
            },
            jump: function (t) {
              this.translate(p(t));
            },
            translate: function (t) {
              (l = t),
                P(o, { transform: "translate" + this.axis + "(" + t + "px)" });
            },
            trim: function (t) {
              return !s.options.trimSpace || s.is(j) ? t : this._s.trim(t);
            },
            toCoord: function (t) {
            ...
            ? ((e = s),
              (i = a),
              {
                ...
                toPosition: function (t) {
                  return -(
                    (t + i.Clones.length / 2) * (d.slideHeight() + d.gap) +
                    this.offset()
                  );
                },
                toIndex: function (t) {
                  var n = d.slideHeight(),
                    e = ((n + d.gap) * i.Clones.length) / 2;
                  return Math.round(-(t + e + this.offset()) / (n + d.gap));
                },
                trim: function (t) {
                  return y(t, -(d.listHeight - (d.height + d.gap)), 0);
                },
                offset: function () {
                  var t = e.options.focus,
                    n = d.slideHeight();
                  return "center" === t
                    ? -(d.height - n) / 2
                    : -(parseInt(t) || 0) * (n + d.gap);
                },
              })
            : ((t = a),
              {
                axis: "X",
                sign: "rtl" === (r = s).options.direction ? 1 : -1,
                init: function () {
                  (u = t.Layout), (c = t.Elements);
                },
                toPosition: function (t) {
                  return this.sign * (u.totalWidth(t - 1) + this.offset(t));
                },
                toIndex: function (t) {
                  (t *= this.sign),
                    r.is(T) && (t = y(t, u.totalWidth(c.total), 0));
                  var n = c.getSlides(!0);
                  for (var e in n) {
                    var i = n[e].index,
                      o = this.sign * this.toPosition(i);
                    if (o < t && t <= o + u.slideWidth(i) + u.gap) return i;
                  }
                  return 0;
                },
                trim: function (t) {
                  return y(
                    t,
                    this.sign * (u.totalWidth(c.total) - (u.width + u.gap)),
                    0
                  );
                },
                offset: function (t) {
                  ...
                  return "center" === n
                    ? -(u.width - e) / 2
                    : -(parseInt(n) || 0) * (e + u.gap);
                },
              })
        );
      function p(t) {
        return h.trim(h.toPosition(t));
      }
      return h;
    }
    function $(o, t) {
      ...
      function r() {
        ...
        var n = t.autoWidth ? a.length : t.perPage,
          e = t.direction === nt ? "Height" : "Width",
          i = t["fixed" + e];
        return (
    ...
    var tt = (function () {
        ...
        return (
          ...
          (o.go = function (t, n) {
            return (
              void 0 === n && (n = !0),
              (this.State.is(V) || (this.State.is(F) && !n)) &&
        ...
        o = m(
          {
            ...
            destroy: function () {
              A([i.list, i.track], "style");
            },
          },
          e.options.direction === nt
            ? ((d = e),
              (h = t.Elements),
              (p = d.root),
              {
                margin: "marginBottom",
                init: function () {
                  (f = d.options), (l = h.track), (this.gap = b(p, f.gap));
                  var t = f.padding,
                    n = t.top,
                    e = void 0 === n ? t : n,
                    i = t.bottom,
                    o = void 0 === i ? t : i;
                  (this.padding = { top: b(p, e), bottom: b(p, o) }),
                    P(l, { paddingTop: w(e), paddingBottom: w(o) });
                },
                slideWidth: function () {
                  return b(p, f.fixedWidth || this.width);
                },
                ...
                get height() {
                  ...
                  return (
                    ...
                    b(p, t) - this.padding.top - this.padding.bottom
                  );
                },
                get listWidth() {
                  return this.width;
                ...
                get listHeight() {
                  return (this.slideHeight() + this.gap) * h.total;
                },
              })
            : ((r = e),
              (a = t.Elements),
              (u = r.root),
              {
                margin:
                  "margin" +
                  ("rtl" === (c = r.options).direction ? "Left" : "Right"),
                height: 0,
                listHeight: 0,
                init: function () {
                  (c = r.options), (s = a.track), (this.gap = b(u, c.gap));
                  var t = c.padding,
                    n = t.left,
                    e = void 0 === n ? t : n,
                    i = t.right,
                    o = void 0 === i ? t : i;
                  (this.padding = { left: b(u, e), right: b(u, o) }),
                    P(s, { paddingLeft: w(e), paddingRight: w(o) });
                },
                totalWidth: function (n) {
                  ...
                  return a
                    ...
                    .reduce(function (t, n) {
                      return t + e.slideWidth(n.index) + e.gap;
                    }, 0);
                },
                slideWidth: function (t) {
                  ...
                  var e =
                    c.fixedWidth ||
                    (this.width + this.gap) / c.perPage - this.gap;
                  return b(u, e);
                },
                slideHeight: function () {
                  var t =
                    c.height || c.fixedHeight || this.width * c.heightRatio;
                  return b(u, t);
                },
                get width() {
                ...
                get listWidth() {
                  var t = a.total;
                  return c.autoWidth ? 5e3 * t : this.totalWidth(t);
                },
              })
        );
      function n() {
        o.init(),
          P(e.root, { maxWidth: w(e.options.width) }),
          i.each(function (t) {
            t.slide.style[o.margin] = w(o.gap);
          }),
          g();
      }
      function g() {
        P(i.list, { width: w(o.listWidth), height: w(o.listHeight) }),
          P(i.track, { height: w(o.height) });
        var n = w(o.slideHeight()),
          t = o.width;
        i.each(function (t) {
          P(t.container, { height: n }),
            P(t.slide, {
              width: e.options.autoWidth ? null : w(o.slideWidth(t.index)),
    ...
    function at(u, c) {
      var e,
        ...
        n = {
          ...
          mount: function () {
            var t = this,
              n = c.Elements.list;
            u.on("touchstart mousedown", a, n)
              .on("touchmove mousemove", h, n, { passive: !1 })
              .on("touchend touchcancel mouseleave mouseup dragend", p, n)
              .on("mounted refresh", function () {
                v(n.querySelectorAll("img, a"), function (t) {
      ...
      function a(t) {
        n.disabled ||
          r ||
          !u.State.is(V) ||
          ((e = d.toCoord(d.position)), (i = g(t, {})), (o = i));
      }
      function h(t) {
        var n;
        i &&
          ...
          r
            ...
            : (function (t) {
                var n = t.offset;
                if (u.State.is(V)) {
                  var e = (180 * Math.atan(lt(n.y) / lt(n.x))) / Math.PI;
                  return s && (e = 90 - e), e < u.options.dragAngleThreshold;
                }
                return !1;
              })(o) && (u.emit("drag", i), (r = !0)));
      }
            ...
            (function (t) {
                ...
                e = lt(n);
              {
                ...
                0 < e &&
                  ...
                  (r = n < 0 ? -1 : 1),
                  (s = d.position),
                  e > o.flickVelocityThreshold &&
                    lt(t.offset[f]) < o.swipeDistanceThreshold &&
                    (s +=
                      r *
                      Math.min(
                        e * o.flickPower,
                        i.width * (o.flickMaxPages || 1)
                      )),
                  (a = d.toIndex(s)) === u.index && (a += r * d.sign),
                  u.is(j) || (a = y(a, 0, l.edgeIndex)),
                  l.go(a, o.isNavigation));
              }
            })(o),
            (r = !1));
      }
    ...
    function ut(o, r, s) {
      ...
      function n() {
        var t = r.Controller,
          n = t.prevIndex,
          e = t.nextIndex,
          i = o.length > o.options.perPage || o.is(j);
        (a.disabled = n < 0 || !i),
          (u.disabled = e < 0 || !i),
    ...
    function dt(a, e) {
      var u = a.i18n,
        i = e.Elements,
        o = [_t, Et, xt, bt, wt, "role"];
      function n(t, n) {
        O(t, _t, !n), O(t, Et, n ? 0 : -1);
      }
      function t(t, n) {
        var e = i.track.id;
        O(t, xt, e), O(n, xt, e);
      ...
      function s(t, n) {
        n && O(n.button, wt, !0),
          t.items.forEach(function (t) {
            ...
            O(i, xt, o.join(" ")), O(i, bt, e);
          });
      }
      function c(t, n, e) {
        n && A(n.button, wt), e && O(e.button, wt, !0);
      }
      function d(s) {
        i.each(function (t) {
          var n = t.slide,
    ...
    var lt = Math.abs,
      ...
      Pt = {
          ...
          function t() {
            ...
            o !== a &&
              ...
              (i = (e = u[o] || s).destroy)
                ...
                : (n.is(U) && (n.set(G), r.mount()), (r.options = e)));
          }
          return {
              ...
              mount: function () {
                ...
                s.slides.length > t.perPage &&
                  ...
                  (function () {
                    ...
                    t.pauseOnHover &&
                      (u(e, "mouseleave", ft, !0), u(e, "mouseenter", ft, !1));
                    t.pauseOnFocus &&
                      (u(e, "focusout", ht, !0), u(e, "focusin", ht, !1));
                    o
                      .on(
                        "click",
                        function () {
              ...
              o.on("mounted refresh", function () {
                a(),
                  t.Elements.each(function (n) {
                    v(n.slide.querySelectorAll("[" + mt + "]"), function (t) {
                      t.src ||
        ...
        Sync: function (i) {
          ...
          function r() {
            i.on(kt, function (t, n, e) {
              o.off(kt).go(o.is(j) ? e : t, !1), s();
            });
          }
          function s() {
            o.on(kt, function (t, n, e) {
              i.off(kt).go(i.is(j) ? e : t, !1), r();
            });
          }
          function a(t) {
            i.State.is(V) && o.go(t);
                  ...
                  o.Components.Elements.each(function (t) {
                    ...
                    i.on(
                      ...
                      i.on(
                        "keyup",
                        function (t) {
                          -1 < St.indexOf(t.key) && (t.preventDefault(), a(e));
                        },
                        n,
                        { passive: !1 }
                      );
    ...
    var Ct = (function (e) {
      var t, n;
      function i(t, n) {
        return e.call(this, t, n, Pt) || this;
      }
      return (
        (n = e),
